...
In the [previous tutorial](/tutorials/transform-bucket-images-triggers-functions-set-up/), you learned how to set up your environment to use Serverless Functions with triggers in order to resize images from a bucket and push them to another one.
...
- A source [bucket](/object/how-to/create-a-bucket/) containing images
- An empty destination bucket
- An [SQS queue](/serverless/messaging/quickstart/#quickstart-for-sqs) with credentials
