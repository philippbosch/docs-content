...
- [Detached all resources](/network/vpc/how-to/attach-resources-to-pn/#how-to-detach-a-resource-from-a-private-network/) from the Private Network you want to delete
