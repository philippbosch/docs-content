...
<Macro id="requirements" />
  ...
  - [Created Grafana credentials](/observability/cockpit/how-to/retrieve-grafana-credentials) with the **Editor** role
  - [Enabled](/observability/cockpit/how-to/enable-alert-manager) the alert manager, and [activated managed alerts](/observability/cockpit/how-to/activate-managed-alerts/)
...
1. [Log in to Grafana](/observability/cockpit/how-to/access-grafana-and-managed-dashboards/) using your credentials.
